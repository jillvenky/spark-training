// Databricks notebook source exported at Wed, 12 Aug 2015 21:01:51 UTC
...
dfA.join(dfB, $"pair1._1.id" === $"pair2._2.id").select($"pair1._1.name", $"pair1._2.name").show()
...
df.join(df, df["source.id"] === df["dest.id"])